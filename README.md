...
<p align="center">
  <img src="presentations/diagram_emulator.png" width="700">
</p>

Supported systems: **Kuramoto–Sivashinsky (KS)** — see branches `main` (L96), `l63`, `kolmogorov-2d` for other experiments.  
Supported training objectives: **Optimal Transport (OT / Sinkhorn)**, **WGAN**, **baseline (L2)**.
Supported training objectives: **Optimal Transport (OT / Sinkhorn)**, **Contrastive Learning (CL)**, **WGAN**, **baseline (L2)**.
